...
san_block_m = ('''\n
               ...
               Im Rahmen des Fachkurs Einheitssanitäter hat er das NAEMT Zertifikat Trauma First Responder (TFR) erhalten \n
               und wurde im Tactical Combat Casuality Care (TCCC) Stufe 3 ausgebildet.\n''')

san_block_w = ('''\n
               <p>\n
               Im Rahmen der Selbst- und Kameradenhilfe hat sie die Ausbildung zur Nothelferin erhalten. \n
               Im Rahmen des Fachkurs Einheitssanitäter hat sie das NAEMT Zertifikat Trauma First Responder (TFR) erhalten \n
               und wurde im Tactical Combat Casuality Care (TCCC) Stufe 3 ausgebildet.\n''')

dd_block_m = ('''\n
              <p>\n
              Als Durchdiener hat er seine Ausbildungspflicht erfüllt \n
              und wird nicht mehr in Wiederholungskurse aufgeboten.\n''')

dd_block_w = ('''\n
              <p>\n
              Als Durchdienerin hat sie ihre Ausbildungspflicht erfüllt \n
              und wird nicht mehr in Wiederholungskurse Aufgeboten. \n''')
