...
san_block_w = ('''\n
               <p>\n
               Nell'ambito dell'aiuto a sé stesso e al camerata, ha ricevuto l'attestato di soccorritore. \n
               Nell'ambito del corso di specializzazione per paramedici dell'unità, ha ottenuto il certificato NAEMT 
               di Trauma First Responder (TFR). \n
               ed è stato addestrato al Tactical Combat Casuality Care (TCCC) di livello 3.\n''')

dd_block_m = ('''\n
              <p>\n
              In qualità di militare in ferma continuata ha adempiuto il suo totale obbligatorio di giorni di servizio d'istruzione \n
              e non viene più chiamato in servizio per corsi di ripetizione. \n''')
